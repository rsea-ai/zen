    ...
    if ($archives_query->have_posts()) : 
        while ($archives_query->have_posts()) : $archives_query->the_post(); 
            ...
            if ($year_current != $year_prev) {
                ...
                <div>
                    <!-- A11y Fix: Contrast text-gray-400 -> text-gray-500 -->
                    <h3 class="text-xl font-bold mb-4 text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-gray-800 pb-2"><?php echo $year_current; ?></h3>
                    <ul class="space-y-4">
            <?php } ?>
            ...
            <li class="flex items-baseline justify-between group">
                ...
                <!-- A11y Fix: Contrast text-gray-400 -> text-gray-500 -->
                <span class="text-sm text-gray-500 dark:text-gray-500 shrink-0 font-mono"><?php echo get_the_date('m-d'); ?></span>
            </li>

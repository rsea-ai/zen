...
<section id="comments" class="mt-20 pt-10 border-t border-gray-100 dark:border-gray-800 max-w-zen mx-auto">
    ...
    <div class="flex items-center justify-between mb-10">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white serif">
            <?php
    ...
    <div class="mb-8">
        ...
        $fields = array(
            'author' => '<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">' .
                        '<div><label for="author" class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">称呼 <span class="text-red-500">*</span></label>' .
            ...
            'email'  => '<div><label for="email" class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">邮箱 <span class="text-red-500">*</span></label>' .
        ...
        $args = array(
            ...
            'logged_in_as' => '<p class="text-xs text-gray-500 mb-6">已登录为 <a href="' . admin_url( 'profile.php' ) . '" class="underline font-medium text-gray-900 dark:text-white">' . $user_identity . '</a>。 <a href="' . wp_logout_url( apply_filters( 'the_permalink', get_permalink() ) ) . '" class="text-red-500 hover:underline">注销?</a></p>',
    ...
    <div class="comment-list-wrapper">
        <?php if ( have_comments() ) : ?>
            ...
            <nav class="mt-12 flex justify-between text-sm font-medium border-t border-gray-100 dark:border-gray-800 pt-8">
        ...
        <?php else : ?>
            <?php if ( ! comments_open() ) : ?>
                <p class="text-sm text-gray-500 italic text-center py-8">评论已关闭。</p>
            <?php endif; ?>
        <?php endif; ?>
    </div>
